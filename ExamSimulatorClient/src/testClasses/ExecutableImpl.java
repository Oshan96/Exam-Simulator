...
//    @Override
//    public void execute(String mainClass) throws Exception{
//        try {
//            URLClassLoader urlClassLoader=new URLClassLoader(new URL[]{new File("./").toURI().toURL()});
//            Class<?> obj=urlClassLoader.loadClass(mainClass);
//            Object ob=obj.newInstance();
//            Method method=obj.getMethod("main",String[].class);
//            System.out.println(method.invoke(ob,new String[0]));
//        } catch (ClassNotFoundException e){
//            throw e;
//        } catch (IllegalAccessException | InstantiationException | MalformedURLException | InvocationTargetException | NoSuchMethodException e) {
//            e.printStackTrace();
...
//        System.out.println(process.exitValue());
    ...
    /*
        //Format of the student given source code is (when "mainClass" parameter is null) :
        ...
        //////////////Final (default) class should look like//////////////
        public class Run{
